...
export const SERVICES_CATALOG: ServiceItem[] = [
  ...
  },
  {
    ...
    stepNumber: "10",
    title: "House Help, Cook, Baby Care & Patient Care",
    shortDesc: "Multi-skilled domestic helpers for flexible working hours across home cooking, dusting, baby nanny, and bedside eldercare. (Maid leave: 2 per month)",
    priceTag: "From ₹5,000 / mo",
    badge: "Transparent Hourly Slabs",
    salarySlab: [
      { hours: "2hr / day", rate: "₹5,000 / mo" },
      { hours: "3hr / day", rate: "₹6,000 / mo" },
      { hours: "4hr / day", rate: "₹7,000 / mo" },
      { hours: "5hr / day", rate: "₹8k - ₹9k / mo" },
      { hours: "6hr / day", rate: "₹9k - ₹10k / mo" },
      { hours: "7hr / day", rate: "₹10k - ₹11k / mo" },
      { hours: "8hr / day", rate: "₹12k - ₹13k / mo" },
      { hours: "9hr / day", rate: "₹12k - ₹13k / mo" },
      { hours: "10hr / day", rate: "₹14k - ₹15k / mo" },
      { hours: "11hr / day", rate: "₹15k - ₹16k / mo" },
      { hours: "12hr / day", rate: "₹15k - ₹17k / mo" },
    ],
    icon: "Users",
    ...
    features: [
      ...
      "Maid leave: 2 per month with replacement support",
      "Police verified & health screened staff"
    ],
    hi: {
      title: "घरेलू सहायिका, कुक, बेबी केयर व पेशेंट केयर",
      shortDesc: "खाना बनाने, शिशु देखभाल, बुजुर्गों व मरीजों की सेवा और घर के कामकाज के लिए कुशल घरेलू सहायक। (मेड छुट्टी: 2 प्रति माह)",
      priceTag: "₹5,000 / माह से शुरू",
      badge: "पारदर्शी घंटेवार स्लैब",
      salarySlab: [
        { hours: "2 घंटे / दिन", rate: "₹5,000 / माह" },
        { hours: "3 घंटे / दिन", rate: "₹6,000 / माह" },
        { hours: "4 घंटे / दिन", rate: "₹7,000 / माह" },
        { hours: "5 घंटे / दिन", rate: "₹8,000 - ₹9,000 / माह" },
        { hours: "6 घंटे / दिन", rate: "₹9,000 - ₹10,000 / माह" },
        { hours: "7 घंटे / दिन", rate: "₹10,000 - ₹11,000 / माह" },
        { hours: "8 घंटे / दिन", rate: "₹12,000 - ₹13,000 / माह" },
        { hours: "9 घंटे / दिन", rate: "₹12,000 - ₹13,000 / माह" },
        { hours: "10 घंटे / दिन", rate: "₹14,000 - ₹15,000 / माह" },
        { hours: "11 घंटे / दिन", rate: "₹15,000 - ₹16,000 / माह" },
        { hours: "12 घंटे / दिन", rate: "₹15,000 - ₹17,000 / माह" },
      ],
      features: [
        "खाना बनाना, डस्टिंग, बेबी केयर या पेशेंट केयर",
        "निश्चित व पारदर्शी मासिक वेतन स्लैब",
        "मेड छुट्टी: प्रति माह 2 (बैकअप सपोर्ट उपलब्ध)",
        "पुलिस सत्यापित व स्वास्थ्य-परीक्षित स्टाफ"
      ],
    },
  },
  {
    id: "live-in-maid-care",
    stepNumber: "11",
    title: "24-Hour Live-In Maid, Nanny & Japa Care",
    shortDesc: "24-hour round-the-clock stay-at-home support for full house management, experienced nanny baby care, and specialized postpartum Japa care.",
    priceTag: "From ₹21k / mo",
    badge: "24-Hour Live-In",
    salarySlab: [
      { hours: "24hr House Help & Cooking", rate: "₹21k - ₹22k / mo" },
      { hours: "24hr Nanny / Baby + House", rate: "₹23k - ₹24k / mo" },
      { hours: "24hr Japa Newborn Care", rate: "₹24k - ₹28k / mo" },
    ],
    icon: "ShieldCheck",
    image: "https://images.unsplash.com/photo-1584820927498-cfe5211fd8bf?w=600&auto=format&fit=crop&q=80",
    features: [
      "24-hour live-in stay-at-home domestic help",
      "Specialized postpartum Japa & infant nanny",
      "Maid leave: 2 per month with backup",
      "100% background checked & verified"
    ],
    hi: {
      title: "24-घंटे लाइव-इन मेड, नानी व जापा केयर",
      shortDesc: "घर में रहकर चौबीसों घंटे खाना बनाना, साफ-सफाई, शिशु देखभाल (नानी) और प्रसवोपरांत नवजात जापा मेड सेवा।",
      priceTag: "₹21,000 / माह से शुरू",
      badge: "24-घंटे लाइव-इन",
      salarySlab: [
        { hours: "24 घंटे हाउस हेल्प व कुक", rate: "₹21,000 - ₹22,000 / माह" },
        { hours: "24 घंटे नानी / बेबी + हाउस", rate: "₹23,000 - ₹24,000 / माह" },
        { hours: "24 घंटे जापा नवजात केयर", rate: "₹24,000 - ₹28,000 / माह" },
      ],
      features: [
        "24 घंटे घर में रहकर सम्पूर्ण घरेलू सहयोग",
        "विशेष प्रसवोपरांत जापा व शिशु देखभाल नानी",
        "मेड छुट्टी: प्रति माह 2 (बैकअप व्यवस्था)",
        "100% पुलिस व पृष्ठभूमि सत्यापित"
      ],
    },
  },
];
