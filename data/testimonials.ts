...
export const TESTIMONIALS_ROW_1: TestimonialItem[] = [
  ...
  },
  {
    ...
    rating: 5,
    comment: "Outstanding cleaning service—very professional and detail-oriented team.",
    verified: true,
    hi: {
      location: "आगरा",
      serviceUsed: "हाउस क्लीनिंग",
      comment: "उत्कृष्ट सफाई सेवा—बेहद पेशेवर और बारीकी से काम करने वाली टीम।",
    },
  },
  {
    id: "r1-5",
    ...
    rating: 5,
    comment: "Very excellent service. Rachna maid is very good at her job. I am satisfied.",
    verified: true,
    hi: {
      location: "आगरा",
      serviceUsed: "घरेलू मेड सेवा",
      comment: "बहुत ही उत्कृष्ट सेवा। रचना मेड अपने काम में बहुत अच्छी हैं। मैं पूरी तरह संतुष्ट हूँ।",
    },
  },
  {
    id: "r1-6",
    ...
    rating: 5,
    comment: "Very good service and cooperative staff. I would definitely recommend them to others.",
    verified: true,
    hi: {
      location: "आगरा",
      serviceUsed: "मेड सेवा",
      comment: "बहुत अच्छी सेवा और सहयोगी स्टाफ। मैं दूसरों को भी इनकी सेवा लेने की सलाह दूंगा।",
    },
  },
  {
    id: "r1-7",
    name: "Aman Gupta",
    location: "Agra",
    serviceUsed: "Domestic Help",
    rating: 5,
    comment: "Honest and reliable company for maid service. I'm happy with their support.",
    verified: true,
    hi: {
      location: "आगरा",
      serviceUsed: "घरेलू सहायिका",
      comment: "मेड सेवा के लिए ईमानदार और भरोसेमंद कंपनी। मुझे उनका सपोर्ट बहुत पसंद आया।",
    },
  },
  {
    id: "r1-8",
    ...
    rating: 5,
    comment: "Nice experience. Bathroom cleaning was done very neatly.",
    verified: true,
    hi: {
      location: "आगरा",
      serviceUsed: "बाथरूम क्लीनिंग",
      comment: "अच्छा अनुभव रहा। बाथरूम की सफाई बहुत ही सफाई से की गई।",
    },
  },
];
...
export const TESTIMONIALS_ROW_2: TestimonialItem[] = [
  ...
  },
  {
    ...
    serviceUsed: "Deep Cleaning",
    rating: 5,
    comment: "Nice service and customer executive is also good, feasible service prices. Overall I am completely satisfied with their services.",
    verified: true,
    hi: {
      location: "आगरा",
      serviceUsed: "डीप क्लीनिंग",
      comment: "बढ़िया सेवा और कस्टमर सपोर्ट भी अच्छा है, कीमतें भी वाजिब हैं। कुल मिलाकर मैं उनकी सेवाओं से पूरी तरह संतुष्ट हूँ।",
    },
  },
  {
    id: "r2-3",
  ...
  },
  {
    ...
    rating: 5,
    comment: "Amazing service! The team was very professional, thorough, and left my house sparkling clean. I would highly recommend them!",
    verified: true,
    hi: {
      location: "आगरा",
      serviceUsed: "डीप हाउस क्लीनिंग",
      comment: "कमाल की सेवा! टीम बहुत पेशेवर थी और पूरे घर को चमका दिया। मैं इनकी सेवा की अत्यधिक सिफारिश करती हूँ!",
    },
  },
  {
    id: "r2-5",
    ...
    serviceUsed: "Deep Cleaning",
    rating: 5,
    comment: "The staff was very good and polite, they cleaned every corner in my house in Agra.",
    verified: true,
    hi: {
      location: "आगरा",
      serviceUsed: "डीप क्लीनिंग",
      comment: "स्टाफ बहुत अच्छा और विनम्र था, उन्होंने आगरा में मेरे घर के हर कोने की बहुत अच्छी सफाई की।",
    },
  },
  {
    id: "r2-6",
    ...
    serviceUsed: "Domestic Help",
    rating: 5,
    comment: "I had a great experience with Maid Pro Solution4 You, I'm so glad.",
    verified: true,
    hi: {
      location: "आगरा",
      serviceUsed: "घरेलू सहायिका",
      comment: "Maid Pro Solution4 You के साथ मेरा अनुभव बहुत शानदार रहा, मुझे बहुत खुशी है।",
    },
  },
  {
    id: "r2-7",
    ...
    serviceUsed: "Maid Service",
    rating: 5,
    comment: "One of the best choices ever, great work with efficiency they are doing.",
    verified: true,
    hi: {
      location: "आगरा",
      serviceUsed: "मेड सेवा",
      comment: "सर्वश्रेष्ठ विकल्पों में से एक, वे पूरी कुशलता और ईमानदारी से काम कर रहे हैं।",
    },
  },
  {
    id: "r2-8",
    name: "Rdx Monu Rajput",
    location: "Agra",
    serviceUsed: "Home Cleaning",
    rating: 5,
    comment: "Great service and very polite staff. Thank you so much sir.",
    verified: true,
    hi: {
      location: "आगरा",
      serviceUsed: "होम क्लीनिंग",
      comment: "शानदार सेवा और बहुत ही विनम्र स्टाफ। आपका बहुत-बहुत धन्यवाद।",
    },
  },
  {
    id: "r2-9",
    ...
    serviceUsed: "Housekeeping",
    rating: 5,
    comment: "Service is super, please visit for the best services.",
    verified: true,
    hi: {
      location: "आगरा",
      serviceUsed: "हाउसकीपिंग",
      comment: "सेवा बहुत बढ़िया है, बेहतरीन घरेलू सेवा के लिए अवश्य संपर्क करें।",
    },
  },
];
