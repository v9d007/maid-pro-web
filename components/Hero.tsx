...
export const Hero: React.FC<HeroProps> = () => {
  ...
  return (
    <section className="relative w-full bg-gradient-to-b from-[#eaf4f2] via-[#f4f9f8]/80 to-white dark:from-[#0e1d24] dark:via-[#0c171d]/80 dark:to-[#0b1318] overflow-hidden py-14 sm:py-20 lg:py-24 transition-colors duration-200">
      {/* Soft Ambient Background Lighting */}
      <div className="absolute top-0 right-1/4 w-[600px] h-[350px] bg-primary/10 dark:bg-emerald-500/10 rounded-full blur-3xl pointer-events-none" />
